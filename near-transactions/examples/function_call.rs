...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let signer_account_id: AccountId = "near-api-rs-1.testnet".parse::<AccountId>()?;
    let signer_secret_key = "ed25519:3pYeqbRyzJ3rKrdXszMPNQosw7yGZguTSsQQ8Vzc4sEHSo1cpdwxWxe5SkqNDNgX6SfWtqu8YaYtfXNMWhFPZRsA".parse::<SecretKey>()?;
